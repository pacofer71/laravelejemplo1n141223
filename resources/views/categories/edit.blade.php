    ...
    <div class="p-4 rounded-xl w-1/2 mx-auto shadow-xl bg-gray-300">
        <form action="{{ route('categories.update', $category) }}" method='POST'>
            ...
            <div class="mb-4">
                ...
                <input id="nombre" type="text" placeholder="Nombre categoría..." name="nombre" value="{{$category->nombre}}"
            ...
            <div class="mb-4">
                ...
                <textarea id="descripcion" placeholder="Descripción categoría..." name="descripcion"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{$category->descripcion}}</textarea>
                @error('descripcion')
                    <x-error>{{ $message }}</x-error>
                @enderror
            </div>
